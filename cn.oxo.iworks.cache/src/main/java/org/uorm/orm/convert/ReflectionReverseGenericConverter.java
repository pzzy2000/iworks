 ...
 *          2012-12-5 郭训长 创建<br/>
 */
public class ReflectionReverseGenericConverter implements IReverseGenericConverter {
      ...
      /*
       * (non-Javadoc)
       * @see org.uorm.orm.convert.ITypeConverter#convert(java.lang.Object,
       * java.lang.Class)
       */
      @Override
       ...
       * (non-Javadoc)
       * @see
       * org.uorm.orm.convert.IReverseGenericConverter#getSourceTypes(java.lang.
       * Class)
       */
      @Override
            ...
            if (cachedConstructors == null) {
                  ...
                  for (Constructor<?> c : constructors) {
                        ...
                        if (Modifier.isPublic(c.getModifiers()) && c.getAnnotation(Deprecated.class) == null) {
                              ...
                              // We are looking for all single-parameter
                              // constructors
                              if (params.length == 1) {
                                    if (cachedConstructors == _EMPTY_CONSTRUCTOR_MAP)
