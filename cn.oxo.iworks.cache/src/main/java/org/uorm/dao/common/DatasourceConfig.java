...
public class DatasourceConfig {
      ...
      public DatasourceConfig(DataBaseType databasetype, String driverClass, String jdbcUrl, String username, String password) {
            super();
      ...
      /**
       * @param poolPerperties
       *              the poolPerperties to set
       */
