...
//
// public static DataSource createDatasource(String pooltype, DatasourceConfig
/// datasourcecfg) throws SQLException {
...
// * @throws SQLException
// */
// private static DataSource genPoolDataSource(String pooltype, DatasourceConfig
/// datasourcecfg) throws SQLException {
// DataSource datasource = null;
// if ( DefaultConnectionFactory._POOL_TYPE_C3P0.equalsIgnoreCase(pooltype) ) {
// datasource = createC3p0DataSource(datasourcecfg);
// } else if (
/// DefaultConnectionFactory._POOL_TYPE_BONECP.equalsIgnoreCase(pooltype) ) {
// datasource = createBoneCPDataSource(datasourcecfg);
// } else if (
/// DefaultConnectionFactory._POOL_TYPE_DBCP.equalsIgnoreCase(pooltype) ) {
// datasource = createDBCPDataSource(datasourcecfg);
// }else if (
/// DefaultConnectionFactory._POOL_TYPE_JDBC_POOL.equalsIgnoreCase(pooltype) ) {
// Boolean XA =
/// Utils.str2Boolean(datasourcecfg.getPoolPerperties().get("isXADataSource"));
// if(XA != null){
