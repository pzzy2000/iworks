...
public class CreateHtml {
      ...
      private void createModuleadd(ModuleDifBean iModuleDifBean, Class<?> clazz) throws Exception {
            System.out.println("->  create html : " + basePath + "/html/default/module/" + iModuleDifBean.getModuleDif().id() + ".html");
            Map<String, Object> values = createVParams(iModuleDifBean, clazz);

            String vm = "template/html/add.html";

            VelocityToolsUnits.toFile(vm, values, basePath + "/html/default/module/" + iModuleDifBean.getModuleDif().id() + "_" + "add.html");
      ...
      private void createModuledelete(ModuleDifBean iModuleDifBean, Class<?> clazz) throws Exception {
            ...
            VelocityToolsUnits.toFile(vm, values, basePath + "/html/default/module/" + iModuleDifBean.getModuleDif().id() + "_" + "delete.html");
      ...
      private void createModulesearch(ModuleDifBean iModuleDifBean, Class<?> clazz) throws Exception {
            ...
            VelocityToolsUnits.toFile(vm, values, basePath + "/html/default/module/" + iModuleDifBean.getModuleDif().id() + "_" + "search.html");
      ...
      private void createModuleUpdate(ModuleDifBean iModuleDifBean, Class<?> clazz) throws Exception {
            ...
            VelocityToolsUnits.toFile(vm, values, basePath + "/html/default/module/" + iModuleDifBean.getModuleDif().id() + "_" + "update.html");
      ...
      private void createModuleHtml(ModuleDifBean iModuleDifBean, Class<?> clazz) throws Exception {
            ...
            VelocityToolsUnits.toFile(vm, values, basePath + "/html/default/module/" + iModuleDifBean.getModuleDif().id() + ".html");

      }

      private void createModuleJs(ModuleDifBean iModuleDifBean, Class<?> clazz) throws Exception {
            System.out.println("->  create html : " + iModuleDifBean.getModuleDif().id() + ".html  ? " + iModuleDifBean.getModuleDif().id() + "/MainOpt.js");
            Map<String, Object> values = createVParams(iModuleDifBean, clazz);

            String vm = "template/html/MainOpt.js";

            VelocityToolsUnits.toFile(vm, values, basePath + "/html/default/module/" + iModuleDifBean.getModuleDif().id() + "/" + iModuleDifBean.getModuleDif().id() + "opt.js");
