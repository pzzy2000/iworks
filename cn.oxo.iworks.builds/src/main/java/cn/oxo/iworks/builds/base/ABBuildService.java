...
public abstract class ABBuildService implements IBuildService {
	...
	protected void buildVueApi(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {
	...
	protected void buildMapper(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {
		...
		try {
			VelocityToolsUnits.toFile(vm, values, outPath + "/service/mybatis/" + clazz.getSimpleName() + "BaseMapper.java");
		} catch (Exception e) {
			throw new MyBatisBuildServiceException(e);
		}
	}

	protected void buildSearchBean(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {
		...
		try {
			VelocityToolsUnits.toFile(vm, values, outPath + "/pojo/bean/" + clazz.getSimpleName() + "SearchBean.java");
		} catch (Exception e) {
			throw new MyBatisBuildServiceException(e);
		}
	}

	protected void buildMapperXml(TableBean iTableBean, Class<?> clazz, String outPath, String vmfile) throws MyBatisBuildServiceException {
	...
	protected void buildMapperXml(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {
	...
	protected void buildInface(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {
	...
	protected void buildAop(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {
		...
		try {
			...
			String aopfileName = "Aop" + clazz.getSimpleName() + "Service.java";
		...
		try {
			...
			VelocityToolsUnits.toFile(vm, values, outPath + "\\controller\\aop\\imples\\" + aopfileName);
		} catch (Exception e) {
			throw new MyBatisBuildServiceException(e);
		}
	}

	protected void buildAction(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {

//		if (StringUtils.isAllEmpty(iTableBean.getAction())) {
//			System.out.println(">>>  TableBean action is null !  no build action java flie  ");
//		}
	...
	protected void buildService(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {
	...
	protected void buildSaveUpdateUnits(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {
		...
		try {
			VelocityToolsUnits.toFile(vm, values, outPath + "\\service\\units\\" + clazz.getSimpleName() + "SaveUpdateRemoveUnits.java");
		} catch (Exception e) {
			throw new MyBatisBuildServiceException(e);
		}
	}

	protected void buildSearchUnits(TableBean iTableBean, Class<?> clazz, String outPath) throws MyBatisBuildServiceException {
		...
		try {
			VelocityToolsUnits.toFile(vm, values, outPath + "\\service\\units\\" + clazz.getSimpleName() + "SearchUnits.java");
		} catch (Exception e) {
			throw new MyBatisBuildServiceException(e);
		}
	}

	protected void buildCrate(TableBean iTableBean, Class<?> clazz, DBUtils dbutils, String vmfile) throws MyBatisBuildServiceException {
	...
	protected void buildCrate(TableBean iTableBean, Class<?> clazz, DBUtils dbutils) throws MyBatisBuildServiceException {
