...
public class Utils {
     ...
     * 
     * @param obj
     *            需要格式化的object,如果不是Date类型，将直接调用该类的toString()方法返回。
     * @param parten
     *            format格式，如果为空，则默认为 "yyyy-MM-dd"
     * @return String
     */
     ...
     * 
     * @param obj
     *            需要格式化的object,如果不是BigDecimal或Float类型，将直接调用该类的toString()方法返回。
     * @param parten
     *            format格式，如果为空，则默认为 "###,##0.00"
     * @return String
     */
