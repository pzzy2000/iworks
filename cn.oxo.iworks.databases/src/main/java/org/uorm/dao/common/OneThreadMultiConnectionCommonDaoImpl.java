...
public class OneThreadMultiConnectionCommonDaoImpl extends CommonDaoImpl {
	private static final Logger logger = LogManager.getLogger(OneThreadMultiConnectionCommonDaoImpl.class);
    ...
    protected <T> T doExecute(StatementCallback<T> action, String sql, final Class<?> paramClass,
        ...
        try {
            ...
            // logger.info("？？？？？？？？？？？？ Executing SQL query [" + sql + "] values: " + Arrays.asList(params));
            // }else{
