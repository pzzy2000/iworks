...
/**
 * <p>
 * A {@link org.apache.shiro.cache.CacheManager} implementation backed by
 * Redisson instance.
 * </p>
 *
 * @author streamone
	...
	public void init() {
		...
		try {
			...
			try {
				...
				throw new IllegalArgumentException("Could not parse cache configuration at [" + configLocation + "]", e1);
			}
		}
	}
