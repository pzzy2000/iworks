...
/**
 * <p>
 * Web-application capable {@link RedissonSessionManager
...
public class RedissonWebSessionManager extends RedissonSessionManager implements WebSessionManager {
      ...
      private Serializable getReferencedSessionId(ServletRequest request, ServletResponse response) {
            ...
            if (id != null) {
                  ...
                  if (id == null) {
                        // not a URI path segment parameter, try the query
                        // parameters:
            ...
            if (id != null) {
                  ...
                  // onUnknownSession method below will be invoked and we'll
