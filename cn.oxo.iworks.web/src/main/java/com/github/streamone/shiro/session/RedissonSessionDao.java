...
public class RedissonSessionDao extends AbstractSessionDAO {
      ...
      protected Session doReadSession(Serializable sessionId) {
            ...
            Long remainTimeToLive = script.eval(infoKey, RScript.Mode.READ_ONLY, RedissonSessionScript.READ_SCRIPT, RScript.ReturnType.INTEGER, keys);
      ...
      public void update(Session session) throws UnknownSessionException {
            // do nothing, the RedissonSession will update the session in redis
            // directly
      }
      ...
      /**
       * <p>
       * Get key name by session id for binding a RMap to store basic
       * informations of the session.
       * </p>
       * <p>
       * In redis cluster, key hash tags ensure that the binding RMaps of a
       * session are allocated in the same hash slot. <a href=
       * "https://redis.io/topics/cluster-spec#keys-hash-tags">https://redis.io/topics/cluster-spec#keys-hash-tags</a>
       * </p>
       *
       * @param sessionId
       *              the session id
      ...
      /**
       * <p>
       * Get key name by session id for binding a RMap to store attributes of
       * the session.
       * </p>
       * <p>
       * In redis cluster, key hash tags ensure that the binding RMaps of a
