...
public class RedissonSessionDao extends AbstractSessionDAO {
	...
	protected Session doReadSession(Serializable sessionId) {
		...
		Long remainTimeToLive = script.eval(infoKey, RScript.Mode.READ_ONLY, RedissonSessionScript.READ_SCRIPT, RScript.ReturnType.INTEGER,
				keys);
	...
	/**
	 * <p>
	 * Get key name by session id for binding a RMap to store basic informations of
	 * the session.
	 * </p>
	 * <p>
	 * In redis cluster, key hash tags ensure that the binding RMaps of a session
	 * are allocated in the same hash slot. <a href=
	...
	/**
	 * <p>
	 * Get key name by session id for binding a RMap to store attributes of the
	 * session.
	 * </p>
	 * <p>
	 * In redis cluster, key hash tags ensure that the binding RMaps of a session
