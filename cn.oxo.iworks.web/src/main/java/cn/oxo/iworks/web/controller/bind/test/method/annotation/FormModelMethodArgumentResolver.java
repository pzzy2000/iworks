// package cn.zy.dev.tools.web.spring.bind.test.method.annotation;
//
...
//
// import cn.zy.dev.tools.web.spring.bind.test.annotation.FormModel;
// import cn.zy.dev.tools.web.spring.bind.test.util.MapWapper;
//
...
// mavContainer.getModel().get(name) : createAttribute(name, parameter,
...
// */
// protected Object createAttribute(String attributeName, MethodParameter
// parameter,
// WebDataBinderFactory binderFactory, NativeWebRequest request) throws
// Exception {
//
// String value = getRequestValueForAttribute(attributeName, request);
//
// if (value != null) {
// Object attribute = createAttributeFromRequestValue(value, attributeName,
...
// protected final Map<String, String> getUriTemplateVariables(NativeWebRequest
// request) {
...
// /**
// * {@inheritDoc}
// * <p>Downcast {@link WebDataBinder} to {@link ServletRequestDataBinder}
// before binding.
// * @throws Exception
...
// ServletRequest servletRequest = prepareServletRequest(binder.getTarget(),
// request, parameter);
...
// WebDataBinder componentBinder = binderFactory.createBinder(request,
// component, null);
...
// String prefixName = getPrefixName((String) key);
//
// Object keyValue = simpleBinder.convertIfNecessary(getMapKey(prefixName),
// keyType);
//
// if(isSimpleComponent(prefixName)) { //bind simple type
// Map<String, Object> paramValues =
...
// }
//
// private ServletRequest prepareServletRequest(Object target, NativeWebRequest
// request, MethodParameter parameter) {
//
// String modelPrefixName =
// parameter.getParameterAnnotation(FormModel.class).value();
//
...
// getUriTemplateVariables(request).entrySet()) {
// String parameterName = entry.getKey();
// String value = entry.getValue();
// if(isFormModelAttribute(parameterName, modelPrefixName)) {
// mockRequest.setParameter(getNewParameterName(parameterName, modelPrefixName),
// value);
// }
// }
//
...
// }
//
// private String getNewParameterName(String parameterName, String
// modelPrefixName) {
...
// }
// throw new IllegalArgumentException("illegal request parameter, can not
// binding to @FormBean("+modelPrefixName+")");
// }
//
// private boolean isFormModelAttribute(String parameterName, String
// modelPrefixName) {
// int modelPrefixNameLength = modelPrefixName.length();
//
...
// }
//
// protected void validateComponent(WebDataBinder binder, MethodParameter
// parameter) throws BindException {
//
...
// * @param parameter the method parameter
// */
// protected void validateIfApplicable(WebDataBinder binder, MethodParameter
// parameter) {
// Annotation[] annotations = parameter.getParameterAnnotations();
// for (Annotation annot : annotations) {
// if (annot.annotationType().getSimpleName().startsWith("Valid")) {
