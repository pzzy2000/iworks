...
//		System.out.println(">>  access  "+optSysManagerUser.getAccess()+" phone "+optSysManagerUser.getPhone()+" password "+optSysManagerUser.getPassword());
//		Object salt = ByteSource.Util.bytes(createShiroLoginAccess(optSysManagerUser.getAccess(), optSysManagerUser.getPhone()));
//		SimpleHash simpleHash = new SimpleHash("MD5", optSysManagerUser.getPassword(), salt, 2);
...
//	public static String createPassword(String accessPhone, String password) {
