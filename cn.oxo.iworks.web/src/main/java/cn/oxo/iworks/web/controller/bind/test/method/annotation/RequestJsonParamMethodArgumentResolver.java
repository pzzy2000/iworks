...
// RequestJsonParam annotation =
/// parameter.getParameterAnnotation(RequestJsonParam.class);
...
// mapType = (MapType)
/// mapType.narrowKey((Class<?>)((ParameterizedType)type).getActualTypeArguments()[0]);
// mapType = (MapType)
/// mapType.narrowContentsBy((Class<?>)((ParameterizedType)type).getActualTypeArguments()[1]);
// }
...
// javaType =
/// javaType.narrowContentsBy((Class<?>)((ParameterizedType)type).getActualTypeArguments()[0]);
// }
//
...
// "too many request json parameter '" + name + "' for method parameter type ["
/// + paramType + "], only support one json parameter");
// }
//
...
//
// @Override
// protected void handleMissingValue(String paramName, MethodParameter
/// parameter) throws ServletException {
// String paramType = parameter.getParameterType().getName();
// throw new ServletRequestBindingException(
// "Missing request json parameter '" + paramName + "' for method parameter type
/// [" + paramType + "]");
// }
//
//
...
// */
// @Override
// public Object resolveArgument(MethodParameter parameter, NativeWebRequest
