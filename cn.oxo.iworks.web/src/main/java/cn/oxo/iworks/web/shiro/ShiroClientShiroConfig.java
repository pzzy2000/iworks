...
public abstract class ShiroClientShiroConfig {
      ...
      /**
       * anon : 不认证 ClientAuthc :需要登录认证 ClientRoles:角色认证 列子 ： put("/sys/login",
       * "CrawlerAuthc") .put("/**", "CrawlerAuthc,ClientRoles[test]")
       * 
       * @return
       */
      ...
      public org.apache.shiro.mgt.SecurityManager securityManager(@Autowired ShiroClientAuthorizingRealm managerPlatformAuthorizingRealm,
                                          @Autowired RedissonWebSessionManager redissonWebSessionManager, @Autowired RedissonShiroCacheManager redissonShiroCacheManager) {
      ...
      @Bean
      public ShiroClientAuthorizingRealm managerPlatformAuthorizingRealm(CredentialsMatcher credentialsMatcher, AuthenticationInfoCache authenticationInfoCache,
                                          AuthorizationInfoCache authorizationInfoCache, @Autowired IShrioClientService shrioClientService) {
